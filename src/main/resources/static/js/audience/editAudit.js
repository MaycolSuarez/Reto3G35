...
function editarRegistro(numId) {
    ...
    $.ajax({
        url: "https://g90f5e6e689aa70-retociclo3.adb.us-sanjose-1.oraclecloudapps.com/ords/admin/audience/audience/" + numId,
        type: 'GET',
        dataType: 'json',
...
function actualizar() {
    ...
    $.ajax({
        url: "https://g90f5e6e689aa70-retociclo3.adb.us-sanjose-1.oraclecloudapps.com/ords/admin/audience/audience",
        data: datosPeticion,
        type: 'PUT',
